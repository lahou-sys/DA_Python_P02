...
def export_to_csv(url,categorie):
    books = extract_all_book_of_categorie(url, categorie)
    header_list = []
    for key in books[0]:
...
#print(extract_all_book_of_categorie(URL, "Religion"))
#print(len(extract_all_book_of_categorie(URL, "Religion")))

#download_all_pictures(URL, "Travel")
